...
public class ConnectDialog extends JDialog {
    ...
    public interface ConnectCallback {
        /**
         * This method tries to connect to a peer with specified settings.
         *
         * @param listenPort port to listen for new incoming messages.
         * @param sendPort   port where new outcoming messagse must be sent.
         * @param hostname   hostname of a peer we are trying to connect to.
         * @param name       a name that will be associated with user in messenger.
         */
